...
public class osc_sin_broadcast extends PApplet {
...
float angle = 0.0f;
float angleColor1 = random(0.0f, 255);
float angleColor2 = random(0.0f, 255);
float speed = 0.001f;
...
public void keyPressed() {
  if (key == '1') {
    ...
    angle = random(0.0f, 100.0f);
    angleColor1 = random(0.0f, 255);
    angleColor2 = random(0.0f, 255);
  }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "osc_sin_broadcast" };
    if (passedArgs != null) {
