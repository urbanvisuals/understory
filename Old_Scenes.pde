...
Scene spinners2 = new Scene("spinners2", "Spinners 2") {
  void setup() {spinners2_setup();}
  void draw() {spinners2_draw();}
};
...
Scene stripes2 = new Scene("stripes2", "Stripes 2") {
  void setup() {stripes2_setup();}
  void draw() {stripes2_draw();}
};
